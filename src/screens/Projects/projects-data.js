...
const ProjectData = [
  ...
  },
  {
    title: 'DockJS',
    imgSource: 'dockjs',
    altText: 'Screenshot of dockjs project',
    description: 'Desktop REPL app built with Electron',
    tools: 'Electron, Babel, jQuery, MenuBar',
    focus: ['Desktop app', 'Filesystem', 'Learn how Electron works'],
    gitHubLink: 'https://github.com/rcwestlake/dockjs',
    detail: ['This project focused on Electron. We wanted to build an app which lived in the menubar of a user\'s desktop. After clicking the icon, a text editor and console drop down, which allows users to write JavaScript (vanillaJS or the new ES6 syntax). We then transpile and evaluate it, printing items in the console.', 'Since the recent additions to JavaScript in ES6/ES7, we wanted to have a feature that allowed a user to upload code in vanilla JS that could be transpiled into ES6 and vice versa.', 'Other features include: changing the text editor theme, saving code to files, and shortnames for "console.log", including "l, log, brew, serve".', 'I worked with one other person on the project, and we plan to put it on the Mac Store soon.'],
  },
  {
    title: 'Weathrly',
    imgSource: 'weathrly',
  ...
  },
  {
    ...
    description: 'Realtime chat app built with React',
    ...
    detail: ['This project was focused on authentication and building a realtime app with multiple users. We used Firebase to store data as well as help with Google auth. Once logged in, a user can see other logged in users and read past messages. They can also sort messages from oldest to newest as well as filter by user.', 'I worked with one other person, and at the beginning of the project, decided we wanted to take an agile, test-driven approach. While not perfect, it was a great experience.', 'The most challenging part was integrating auth with Firebase and managing a larger user base.'],
  },
  {
